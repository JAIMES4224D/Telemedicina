...
public class medico {
    ...
    public medico(int idMedico, String nombres, String apellidos, int idEspecialidad, int idSubespecialidad, String numeroColegiatura, String universidad, String correoElectronico, String numeroTelefono, String descripcion, String nombreEspecialidad) {
