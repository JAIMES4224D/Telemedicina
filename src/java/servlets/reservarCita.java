 ...
 * @author JEJALUOS
 */
@WebServlet(name = "reservarCita", urlPatterns = {"/reservarCita"})
public class reservarCita extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("users/paciente/prueba.jsp").forward(request, response);
