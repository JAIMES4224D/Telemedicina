...
public class registroMedico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (fotoPart != null && fotoPart.getSize() > 0) {
            ...
            // Ejemplo: guardar en la BD como BLOB
            // ps.setBlob(3, inputStream);
        }
        int idEspecialidad = Integer.parseInt(request.getParameter("idEspecialidad"));
        int idSubespecialidad = Integer.parseInt(request.getParameter("idSubespecialidad"));
        ...
        int registrado = in.registrarMedico(nombres, apellidos, fotoPart, idEspecialidad, idSubespecialidad, colegiatura, universidad, telefono, correo, descripcion, username, password);
        // Mostrar respuesta
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                if (registrado > 0) {
                    ...
                    out.println("<h3 class='text-success'>Medico registrado</h3>");
                    ...
                    out.println("<a href='users/administrativo/registrarMedico.jsp' class='btn btn-danger mt-3'>Reintentar</a>");
                    out.println("</div>");
                }
