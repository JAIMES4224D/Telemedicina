...
<head>
    ...
    <title>Historia del Paciente - Policlínico Wiener Sistem</title>
...
<body>
   ...
   class="nav-link">
                ...
                <li class="nav-item">
                    <a href="<%= request.getContextPath() %>/inicioPaciente?acc=historial&idPaciente=<%= session.getAttribute("idPaciente")%>" class="nav-link active" >
        ...
        <main class="main-content">
            ...
            <form action="inicioPaciente" method="Post" >
                <%
                    List<historiaClinica> listarCitas = (List<historiaClinica>) request.getAttribute("listaHistorial");
                %>
                <table>
                    <thead>
                        <tr>
