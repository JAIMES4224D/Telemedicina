<%@page import="modelo.mensajesContacto"%>
...
<head>
    ...
    <title>Lista de Mensajes - Policlínico Wiener Sistem</title>
      ...
      <main class="main-content">
            <div class="page-header">
                <div class="page-title">
                    <h1 aling="center" >MENSAJES REGISTRADOS EN LA WEB</h1>
                </div>
            </div>

            <div class="table-container">
                <h2 class="section-title">Lista de Mensajes</h2>
                <%
                    List<mensajesContacto> listarCitas = (List<mensajesContacto>) request.getAttribute("listaMensajes");
                %>
                <table>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <%
                            if(listarCitas != null && !listarCitas.isEmpty()){
                                for(mensajesContacto c : listarCitas){
                        %>
                        <tr>
                            <td><%= c.getNombresCompletos()  %></td>
