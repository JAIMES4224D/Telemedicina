    ...
    <div class="app-container">
        ...
        <main class="main-content">
            <div class="form-container">
                ...
                <form action="<%= request.getContextPath() %>/registrarHorario" method="post">
                    ...
                    ResultSet rs = null;
                    String sql = "SELECT idMedico, nombres, apellidos FROM medico";
                    %>
                    ...
                    <div class="form-group">
                        ...
                        <select name="idMedico" id="idMedico" required>
                            ...
                            try{
                                ...
                                while(rs.next()){
                            %>
                                <option value="<%= rs.getInt("idMedico")%>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" name="horaInicio" required>
                    </div>
                    
                    <!-- Hora de fin -->
                    <div class="form-group">
                        <label>Hora de Fin</label>
                        <input type="datetime-local" name="horaFin" required>
                    </div>
                   
                   

                    <!-- Botón -->
                    <button type="submit" class="btn-submit">Registrar Enlace</button>
                </form>
        <script>
        document.addEventListener('DOMContentLoaded', function() {
            const btnAbrirMeet = document.getElementById('btnAbrirMeet');
            const enlaceMeet = document.getElementById('enlaceMeet');
            
            btnAbrirMeet.addEventListener('click', function() {
                // Abrir Google Meet en una nueva pestaña
                window.open('https://meet.google.com/', '_blank');
            });
            
            // Opcional: Si quieres que al pegar un enlace se valide automáticamente
            enlaceMeet.addEventListener('paste', function(e) {
                setTimeout(function() {
                    const valor = enlaceMeet.value;
                    if (valor && !valor.startsWith('https://meet.google.com/')) {
                        alert('Por favor, ingrese un enlace válido de Google Meet');
                        enlaceMeet.value = '';
                    }
                }, 100);
            });
