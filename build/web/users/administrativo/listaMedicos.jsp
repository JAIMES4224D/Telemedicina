    ...
    <div class="app-container">
        ...
        <aside class="sidebar">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item">
                    <a href="<%= request.getContextPath() %>/listarServlet?acc=lmedico" class="nav-link active">
        ...
        <main class="main-content">
            <div class="page-header">
                <div class="page-title">
                    <h1 aling="center" >MEDICOS REGISTRADOS EN EL POLICLINICO</h1>
                </div>
            </div>

            <div class="table-container">
                <h2 class="section-title">Lista de Médicos</h2>
                <%
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><%= m.getNumeroColegiatura() %></td>
                            <td><%= m.getNumeroTelefono() %></td>
