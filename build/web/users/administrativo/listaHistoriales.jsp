...
<head>
    ...
    <title>Lista de Historiales - Policlínico Wiener Sistem</title>
    ...
    <div class="app-container">
        ...
        <aside class="sidebar">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item">
                    <a href="<%= request.getContextPath() %>/listarServlet?acc=lhistorial" class="nav-link active">
      ...
      <main class="main-content">
            <div class="page-header">
                <div class="page-title">
                    <h1 aling="center" >HISTORIAS REGISTRADAS EN EL POLICLINICO</h1>
                </div>
            </div>

            <div class="table-container">
                <h2 class="section-title">Lista de Historias Clincias Realizadas</h2>
                <%
                    List<historiaClinica> listarCitas = (List<historiaClinica>) request.getAttribute("listarHist");
                %>
                <table>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <%
                            if(listarCitas != null && !listarCitas.isEmpty()){
                                for(historiaClinica c : listarCitas){
                        %>
                        <tr>
                            <td><%= c.getNombrePac() %></td>
                            <td><%= c.getSintomas() %></td>
                        ...
                        %>
                        <tr>
                            <td colspan="6" style="text-align:center;">No hay Historias registradas.</td>
                        </tr>
                        <%    
                            }
                        %>
