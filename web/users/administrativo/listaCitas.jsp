...
<head>
    ...
    <title>Lista de Citas - Policlínico Wiener Sistem</title>
    ...
    <div class="app-container">
        ...
        <aside class="sidebar">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item">
                    <a href="<%= request.getContextPath() %>/listarServlet?acc=lcita" class="nav-link active">
      ...
      <main class="main-content">
            ...
            <div class="table-container">
                ...
                <%
                    List<citaMedica> listarCitas = (List<citaMedica>) request.getAttribute("listarCitas");
                %>
                <table>
                    <thead>
                        <tr>
