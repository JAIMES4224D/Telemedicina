...
<head>
    <meta charset="UTF-8">
    <title>Registro de Especialidad - Policlínico Wiener Sistem</title>
    ...
    <div class="app-container">
        ...
        <main class="main-content">
            <div class="form-container">
                ...
                <form action="<%= request.getContextPath() %>/registroEspecialidad" method="post">
                    
                    <div class="form-group">
                        <label>Nombre de la Especialidad</label>
                        <input type="text" name="nombreEspecialidad" required>
                    </div>
                    ...
                    <button type="submit" class="btn-submit">Registrar Especialidad</button>
                </form>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><%= rs.getInt("id") %></td>
                            <td><%= rs.getString("nombreEspecialidad") %></td>
                            <td>S/. <%= rs.getBigDecimal("precio") %></td>
                        </tr>
                        <% } %>
                    </tbody>
                </table>
                ...
                %>
                    <p style="text-align:center; margin-top:2rem;">No hay especialidades registradas.</p>
                <%
                        }
                    } catch(Exception e){
                        e.printStackTrace();
