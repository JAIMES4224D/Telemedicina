    ...
    <div class="app-container">
        ...
        <aside class="sidebar">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item">
                    <a href="<%= request.getContextPath() %>/users/administrativo/listaMedicos.jsp" class="nav-link">
                        <i class="bi bi-person-plus"></i> Médicos
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<%= request.getContextPath() %>/users/administrativo/listaPacientes.jsp" class="nav-link">
                        <i class="bi bi-people"></i> Pacientes
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<%= request.getContextPath() %>/users/administrativo/listaCitas.jsp" class="nav-link">
                        <i class="bi bi-calendar-event"></i> Citas
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<%= request.getContextPath() %>/users/administrativo/listaHistoriales.jsp" class="nav-link">
     ...
     <main class="main-content">
            <div class="form-container">
                ...
                <form action="<%= request.getContextPath() %>/registroAdministrativo" method="post" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="btn-submit">Registrar Administrativo</button>
                </form>
            </div>
        </main>
    </div>
