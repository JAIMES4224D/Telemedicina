...
<head>
    ...
    <title>Panel Administrativo - Policlínico Wiener Sistem</title>
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div class="page-title">
                    ...
                    <p>Bienvenido al sistema administrativo del Policlínico</p>
                </div>
            ...
            <div class="dashboard-grid">
                <div class="stat-card stat-doctors">
                    ...
                    <div class="stat-info">
                        <h3><%= session.getAttribute("cantMedicos") %></h3>
                ...
                <div class="stat-card stat-patients">
                    ...
                    <div class="stat-info">
                        <h3><%= session.getAttribute("cantPacientes") %></h3>
                ...
                <div class="stat-card stat-admins">
                    ...
                    <div class="stat-info">
                        <h3><%= session.getAttribute("cantAdm") %> </h3>
                        <p>Administradores</p>
                    </div>
                </div>
            </div>
            ...
            <div class="quick-actions-grid">
                <div class="action-card">
                    ...
                    <a href="<%= request.getContextPath() %>/users/administrativo/registrarMedico.jsp" class="action-btn">Acceder</a>
                </div>
                ...
                <div class="action-card">
                    ...
                    <a href="<%= request.getContextPath() %>/users/administrativo/registrarHorarios.jsp" class="action-btn">Acceder</a>
                </div>
                ...
                <div class="action-card">
                    ...
                    <a href="<%= request.getContextPath() %>/users/administrativo/registrarAdministrativo.jsp" class="action-btn">Acceder</a>
                </div>
                ...
                <div class="action-card">
                    ...
                    <h3>Enlaces Meet</h3>
                    <a href="<%= request.getContextPath() %>/users/administrativo/registrarMeet.jsp" class="action-btn">Acceder</a>
                </div>
                ...
                <div class="action-card">
                    ...
                    <h3>Reportes</h3>
                    <a href="<%= request.getContextPath() %>/users/administrativo/reportes.jsp"class="action-btn">Acceder</a>
                </div>
                ...
                <div class="action-card">
                    ...
                    <a href="<%= request.getContextPath() %>/users/administrativo/registrarEspecialidad.jsp" class="action-btn">Acceder</a>
                </div>  
                ...
                <div class="action-card">
                    ...
                    <h3>Mensajes Web</h3>
                    <a href="<%= request.getContextPath() %>/listarServlet?acc=mensajeWeb" class="action-btn">Acceder</a>
                </div>
            </div>
                ...
                datasets: [
                    {
                        ...
                        data: [65, 59, 80, 81, 56, 55, 72, 68, 75, 80, 60, 73],
                        backgroundColor: 'rgba(26, 124, 201, 0.7)',
                        borderColor: 'rgba(26, 124, 201, 1)',
                        borderWidth: 1
                    },
                    {
                        label: 'Pacientes Atendidos',
                        data: [52, 48, 65, 70, 53, 45, 62, 65, 70, 75, 58, 68],
