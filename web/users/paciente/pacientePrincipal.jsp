...
<head>
    ...
    <title>Panel del Paciente - Policlínico Wiener Sistem</title>
...
<body>
    <div class="app-container">
        ...
        <aside class="sidebar">
            ...
            <ul class="nav-menu">
                <li class="nav-item">
                    <a href="<%= request.getContextPath() %>/inicioPaciente?acc=actualizar" class="nav-link active ">
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div class="page-title">
                    <h1>Bienvenido, <%= session.getAttribute("nombres") %></h1>
                    <p>Gestiona tus citas y servicios médicos</p>
                </div>
            ...
            <div class="quick-actions-grid">
                <div class="action-card">
                    ...
                    <h3>Reservar Cita</h3>
                    <a href="<%= request.getContextPath() %>/inicioPaciente?acc=reservarCita" class="action-btn">Reservar Ahora</a>
                </div>
                ...
                <div class="action-card">
                    ...
                    <h3>Ver Historial</h3>
                    <a href="<%= request.getContextPath() %>/inicioPaciente?acc=historial&idPaciente=<%= session.getAttribute("idPaciente")%>" class="action-btn">Acceder</a>
                </div>
                ...
                <div class="action-card">
                    ...
                    <h3>Mis Recetas</h3>
                    <a href="<%= request.getContextPath() %>/inicioPaciente?acc=recetas&idPaciente=<%= session.getAttribute("idPaciente")%>" class="action-btn">Ver Todas</a>
                </div>
                ...
                <div class="action-card">
                    ...
                    <h3>Pagos</h3>
                    <a href="#" class="action-btn">Realizar Pago</a>
                </div>
            </div>
