    ...
    <div class="app-container">
        ...
        <aside class="sidebar">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item">
                    <a href="<%= request.getContextPath() %>/controlMedico?acc=misCitas&idMedico=<%= session.getAttribute("idMedico") %>" class="nav-link active">
            ...
            <div class="sidebar-footer">
                ...
                <%
                    List<citaMedica> listarCitas = (List<citaMedica>) request.getAttribute("listaCitas");
        ...
        <main class="main-content">
            <div class="page-header">
                <div class="page-title">
                    <h1 aling="center" >CITAS REGISTRADAS </h1>
                </div>
            </div>
            <table>
                    <thead>
                    ...
                    <tbody>
                        <%
                            if(listarCitas != null && !listarCitas.isEmpty()){
                                for(citaMedica c : listarCitas){ 
                            System.out.println("c.getId() = " + c.getId());
                        %>
                        <tr>
                            <td><%= c.getNombreMedico() %></td>
                            <td><%= c.getNombrePaciente() %></td>
                            <td><%= c.getNombreEspecialidad() %></td>
                            <td><%= c.getHoraInicio1() %></td>
                            <td><%= c.getEstado() %></td>
                            <td><%= c.getFechaRegistro() %></td>
                            <td>S/. <%= c.getPrecio() %></td>
                            <td><a href="<%= c.getEnlace() %>" target="_blank" class="btn btn-primary btn-sm">
                                Ingresar a la cita
                            </a></td>
                            <td><a href="<%= request.getContextPath() %>/controlMedico?acc=atender&idCita=<%= c.getId() %>" target="_blank" class="btn btn-primary btn-sm" >
                                Atender Cita
                                </a>
                            </td>
                        </tr>
                        ...
                        %>
                        <tr>
                            <td colspan="6" style="text-align:center;">No hay recetas registradas.</td>
                        </tr>
                        <%    
                            }
                        %>
